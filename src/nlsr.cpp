...
void
Nlsr::addDispathcerTopPrefix(const ndn::Name& topPrefix)
{
  try {
...
Nlsr::initialize()
{
  ...
  addDispathcerTopPrefix(m_confParam.getRouterPrefix());
  addDispathcerTopPrefix(LOCALHOST_PREFIX);
...
void
Nlsr::onCommandSuccess(const ndn::nfd::ControlParameters& cp)
{
...
void
Nlsr::onCommandFailure(const ndn::nfd::ControlResponse& cr)
{
